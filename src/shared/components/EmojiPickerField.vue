...
.emoji-overlay{overscroll-behavior:none;touch-action:none}.emoji-sheet{overscroll-behavior:none}.icon-groups{overscroll-behavior:contain;touch-action:pan-y;-webkit-overflow-scrolling:touch}
</style>
