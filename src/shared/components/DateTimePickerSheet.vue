...
.datetime-picker-sheet{box-sizing:border-box;width:min(calc(100% - 16px),430px);max-height:94dvh;margin:0 auto;padding:14px 14px calc(16px + var(--safe-bottom));display:grid;gap:9px;overflow-x:hidden;overflow-y:auto;border-radius:26px 26px 0 0;background:var(--surface);box-shadow:0 -18px 50px rgba(35,27,23,.25)}
