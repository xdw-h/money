...
<template>
  <div class="recovery-overlay" @click.self="emit('close')" @touchmove.self.prevent><section class="recovery-sheet" role="dialog" aria-modal="true" aria-label="应用锁恢复">
...
<style scoped>
.recovery-overlay{overscroll-behavior:none}.recovery-sheet{max-height:88dvh;overflow:auto;overscroll-behavior:contain;-webkit-overflow-scrolling:touch}
</style>
