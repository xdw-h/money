...
.recent-controls .sort-button{display:inline-flex;align-items:center;justify-content:center;gap:2px;line-height:1}.sort-button span{display:block}.sort-button i{width:10px;height:10px;display:grid;place-items:center;transform:translateY(-1px);font-size:10px;font-style:normal;line-height:1}
</style>
