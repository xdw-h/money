...
<template>
  <main class="page home-page">
    ...
    <section class="quick-actions" aria-label="快捷操作"><RouterLink to="/record/new"><i>✎</i><span>记一笔</span></RouterLink><RouterLink to="/bills"><i>▤</i><span>明细</span></RouterLink><RouterLink to="/bills?view=statistics"><i>◔</i><span>统计</span></RouterLink><RouterLink to="/timeline"><i>◷</i><span>时间轴</span></RouterLink></section>
